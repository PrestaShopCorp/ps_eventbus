export default {
    ...
    prestashopUrl: process.env.RUN_IN_DOCKER === '1' ? 'http://prestashop' : 'http://localhost:8000',
    prestaShopHostHeader: 'localhost:8000',

    mockBaseUrl: process.env.RUN_IN_DOCKER === '1' ? 'http://reverse-proxy' : 'http://localhost:3030',
