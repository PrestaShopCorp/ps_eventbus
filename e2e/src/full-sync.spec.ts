...
const isDateString = (val) => (val ? expect(val).toBeDateString() : expect(val).toBeNull());
const isString = (val) => (val ? expect(val).toBeString() : expect(val).toBeNull());
const isNumber = (val) => (val ? expect(val).toBeNumber() : expect(val).toBeNull());
const isBoolean = (val) => (val ? expect(val).toBeBoolean() : expect(val).toBeNull());
