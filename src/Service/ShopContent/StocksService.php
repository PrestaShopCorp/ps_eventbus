...
use PrestaShop\Module\PsEventbus\Repository\NewRepository\StockRepository;
...
class StocksService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->stockRepository->retrieveContentsForFull($offset, $limit, $langIso, $debug);
    ...
    {
        $result = $this->stockRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $debug);
