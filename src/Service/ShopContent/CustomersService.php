...
class CustomersService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->customerRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->customerRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
