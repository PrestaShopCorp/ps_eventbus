...
class SpecificPricesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->specificPriceRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->specificPriceRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
