...
class ImagesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->imageRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->imageRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
