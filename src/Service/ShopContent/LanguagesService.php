...
class LanguagesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->languageRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->languageRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
