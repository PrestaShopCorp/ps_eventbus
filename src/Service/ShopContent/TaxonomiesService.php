...
class TaxonomiesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->taxonomyRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->taxonomyRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
