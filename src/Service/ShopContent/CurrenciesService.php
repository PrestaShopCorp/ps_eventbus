...
class CurrenciesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->currencyRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->currencyRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
