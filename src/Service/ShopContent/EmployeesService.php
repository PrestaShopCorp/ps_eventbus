...
class EmployeesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->employeeRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->employeeRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
