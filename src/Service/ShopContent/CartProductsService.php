...
class CartProductsService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->cartProductRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->cartProductRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
