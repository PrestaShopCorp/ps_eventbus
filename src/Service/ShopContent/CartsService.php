...
class CartsService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->cartRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->cartRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
