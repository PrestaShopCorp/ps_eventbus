...
class ImageTypesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->imageTypeRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->imageTypeRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
