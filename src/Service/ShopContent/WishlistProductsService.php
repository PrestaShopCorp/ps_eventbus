...
class WishlistProductsService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->wishlistProductRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->wishlistProductRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
