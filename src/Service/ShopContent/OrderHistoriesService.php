...
class OrderHistoriesService extends ShopContentAbstractService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->orderHistoryRepository->retrieveContentsForIncremental($limit, array_column($upsertedContents, 'id'), $langIso);
