...
class CategoriesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->categoryRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->categoryRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
