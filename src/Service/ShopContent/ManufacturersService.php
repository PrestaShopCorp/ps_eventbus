...
use PrestaShop\Module\PsEventbus\Repository\NewRepository\ManufacturerRepository;
...
class ManufacturersService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->manufacturerRepository->retrieveContentsForFull($offset, $limit, $langIso, $debug);
    ...
    {
        $result = $this->manufacturerRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $debug);
