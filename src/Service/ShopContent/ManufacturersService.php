...
class ManufacturersService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->manufacturerRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->manufacturerRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
