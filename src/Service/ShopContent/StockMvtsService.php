...
class StockMvtsService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->stockMvtRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->stockMvtRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
