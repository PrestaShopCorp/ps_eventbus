...
use PrestaShop\Module\PsEventbus\Repository\NewRepository\TranslationRepository;
...
class TranslationsService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->translationRepository->retrieveContentsForFull($offset, $limit, $langIso, $debug);
    ...
    {
        $result = $this->translationRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $debug);
