...
class ProductBundlesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->productBundleRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->productBundleRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
