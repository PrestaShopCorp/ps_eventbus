...
class OrderCartRulesService implements ShopContentServiceInterface
{
    ...
    {
        $result = $this->orderCartRuleRepository->retrieveContentsForFull($offset, $limit, $langIso, $explainSql);
    ...
    {
        $result = $this->orderCartRuleRepository->retrieveContentsForIncremental($limit, $contentIds, $langIso, $explainSql);
