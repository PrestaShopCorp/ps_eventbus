...
function upgrade_module_3_0_12($module)
{
    ...
    if (in_array($result[0]['version'], ['3.0.8', '3.0.9', '3.0.10', '3.0.11'])) {
        $truncateIncrementalSyncTable = 'TRUNCATE TABLE `' . _DB_PREFIX_ . '_eventbus_incremental_sync`;';
        $truncateTypeSyncTable = 'TRUNCATE TABLE `' . _DB_PREFIX_ . '_eventbus_type_sync`;';
